...
# 自动写入/更新 AGENTS.md 与 CLAUDE.md`,
	  ...
	  'immich': {
	    name: 'Immich 照片管理部署运维服务',
	    projectName: 'Immich',
	    rating: 5,
	    github: 'https://github.com/immich-app/immich',
	    docs: 'https://immich.app/docs',
	    intro: 'Immich 是高性能的自托管照片与视频管理平台，目标是成为 Google Photos 的开源替代。支持移动端自动备份、CLIP 语义搜图、人脸识别与聚类、地图时间线、共享相册与外部媒体库等功能。我们提供从部署、存储规划到长期运维的完整交付。',
	    features: [
	      { icon: '📷', title: '智能搜图', desc: 'CLIP 模型驱动的语义搜索，用自然语言搜索照片内容' },
	      { icon: '👤', title: '人脸识别', desc: '自动人脸检测与聚类，按人物浏览与管理照片' },
	      { icon: '📱', title: '移动备份', desc: 'iOS/Android 客户端自动后台备份，支持 WiFi 限制与增量同步' },
	      { icon: '🗺️', title: '地图时间线', desc: '按地理位置和时间轴浏览照片，支持反向地理编码' },
	    ],
	    deployment: [
	      { title: '环境部署', desc: 'Docker Compose 编排（PostgreSQL + Redis + ML 容器），存储路径规划与性能配置' },
	      { title: '存储规划', desc: '外部存储库配置、备份策略、大容量 NAS / 对象存储接入' },
	      { title: 'ML 模型配置', desc: 'CLIP 搜索模型、人脸识别模型选型与 GPU 加速配置' },
	      { title: '移动端接入', desc: 'iOS/Android 客户端配置、反向代理 HTTPS 与证书管理' },
	      { title: '用户与权限', desc: '多用户账号体系、共享相册、外部共享链接与访问控制' },
	    ],
	    maintenance: [
	      { title: '监控告警', desc: '服务存活、存储容量、ML 任务队列、数据库连接与备份状态监控' },
	      { title: '版本升级', desc: '跟踪官方 Release，执行数据库迁移验证与回滚保障' },
	      { title: '存储治理', desc: '重复照片清理、缩略图重建、转码任务管理与冷热数据分层' },
	      { title: '性能调优', desc: 'ML 推理加速、数据库索引优化、缓存策略与并发配置' },
	    ],
	    whyUs: [
	      { title: '生产级运维', desc: '已实际部署并管理 50,000+ 张照片的 Immich 实例，熟悉全链路运维' },
	      { title: '存储专长', desc: '擅长大容量存储规划、备份策略与跨平台迁移' },
	      { title: '快速响应', desc: '本地化技术支持，问题定位与修复响应及时' },
	      { title: '持续服务', desc: '紧跟 Immich 快速迭代节奏，提供长期升级与优化' },
	    ],
	  },
	  'karakeep': {
	    name: 'Karakeep 书签管理部署运维服务',
	    projectName: 'Karakeep',
	    rating: 5,
	    github: 'https://github.com/karakeep-app/karakeep',
	    docs: 'https://docs.karakeep.app',
	    intro: 'Karakeep（原名 Hoarder）是 AI 驱动的自托管书签与稍后阅读管理器。支持链接、笔记和图片收藏，自动抓取网页内容、AI 标签分类、全文搜索，配合浏览器扩展与移动端应用实现一键保存。适合个人知识管理、团队资料归档等场景。我们提供从部署到长期运维的完整交付。',
	    features: [
	      { icon: '🤖', title: 'AI 标签', desc: '基于 LLM 自动分析内容并生成标签，免去手动分类' },
	      { icon: '🔍', title: '全文搜索', desc: '自动抓取并索引网页全文内容，支持中英文搜索' },
	      { icon: '🌐', title: '浏览器扩展', desc: 'Chrome/Firefox 扩展一键保存，支持批量导入' },
	      { icon: '📋', title: '多格式收藏', desc: '支持链接、纯文本笔记、图片等多种内容类型' },
	    ],
	    deployment: [
	      { title: '环境部署', desc: 'Docker Compose 部署（Next.js + Chrome 无头浏览器 + Meilisearch），反向代理配置' },
	      { title: 'AI 对接', desc: 'OpenAI / Ollama 本地模型配置，自动标签与摘要生成' },
	      { title: '浏览器扩展', desc: 'Chrome/Firefox 扩展安装与服务端连接配置' },
	      { title: '数据迁移', desc: '从 Pocket/Instapaper/浏览器书签批量导入' },
	      { title: '移动端接入', desc: 'iOS/Android 客户端配置与 PWA 访问' },
	    ],
	    maintenance: [
	      { title: '监控告警', desc: '服务存活、Chrome 抓取队列、Meilisearch 索引健康与磁盘监控' },
	      { title: '版本升级', desc: '跟踪官方版本，执行数据库迁移与配置兼容性验证' },
	      { title: '索引维护', desc: 'Meilisearch 索引重建、失败抓取重试与内容质量巡检' },
	      { title: '备份恢复', desc: '数据库与配置定期备份，恢复演练验证' },
	    ],
	    whyUs: [
	      { title: '实战经验', desc: '已在生产环境部署并管理 Karakeep 实例，熟悉全链路配置' },
	      { title: 'AI 集成专长', desc: '擅长 LLM 模型对接与自动标签策略调优' },
	      { title: '快速响应', desc: '本地化技术支持，沟通无时差' },
	      { title: '知识管理视角', desc: '从用户使用场景出发优化配置，而非只做技术部署' },
	    ],
	  },
	};
