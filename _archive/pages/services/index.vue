...
const services = [
  ...
  },
  {
    ...
    name: 'AnythingLLM 部署运维',
    desc: '全栈 RAG 应用：解耦 LLM / 向量数据库 / Embedder 为可插拔模块。工作区级知识隔离，多模态数据管道，桌面版 + Docker 服务版双形态，私有部署数据不出域。',
    stars: '30.7k',
    source: 'Mintplex Labs',
    category: 'knowledge',
    features: ['模块解耦', '工作区隔离', '多模态管道', '专业服务'],
  },
  {
    id: 'immich',
    icon: 'fa-solid fa-camera-retro',
    name: 'Immich 照片管理部署',
    desc: '高性能自托管照片与视频管理平台，支持 CLIP 语义搜图、人脸识别、地图时间线、移动端自动备份，完整替代 Google Photos 的开源方案。',
    stars: '58.6k',
    source: 'Immich',
    category: 'knowledge',
    features: ['语义搜图', '人脸识别', '自动备份', '专业服务'],
  },
  {
    id: 'karakeep',
    icon: 'fa-solid fa-bookmark',
    name: 'Karakeep 书签管理部署',
    desc: 'AI 驱动的自托管书签与稍后阅读管理器。支持链接、笔记和图片收藏，自动抓取内容、AI 标签分类、全文搜索，浏览器扩展一键保存。',
    stars: '12.8k',
    source: 'Karakeep',
    category: 'knowledge',
    features: ['AI 标签', '全文搜索', '浏览器扩展', '专业服务'],
  },
];
